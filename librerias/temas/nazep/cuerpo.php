...
Funci�n archivo: archivo que genera el cuerpo del tema por defecto nazep para su visualizaci�n
...
<!--Inicio Columna Izquierda -->
		<td width="150" valign="top">
			<table width="150" border="0" cellspacing="0" cellpadding="0" align="center" class="imagen_fondo_menu_lateral" >
				<tr>
            		<td valign="top" class="imagen_fondo_menu_lateral_sup" height="25">&nbsp;</td>
           		</tr>
				<tr>
					<td valign="top" align = "center" >
                    	<table style="width:130px;" border="0" cellspacing="5" cellpadding="0" ><tr><td >
                    	<?php
						$this->form_buscador("130", "10", "Buscar");
						echo '<br />';		
						$imagen_balazo = $ubicacion_tema.'image/bullet_prin.jpg';
						$this->lis_secc_prin_ver_tablas("8", "999", "130", "si", "Secciones principales extras", "si", $ubicacion_tema,"5", $imagen_balazo, "Balazo", "Balazo");
						if($sec!="1")
							{	
								echo '<br/>';
						...
						echo '<br/>';
						$this->listar_mod_secundarios_vert_tabla_persistentes($sec, "izquierda", "140");
                        ?>
                       </td></tr></table>
					</td>
				</tr>
				<tr>
                	<td valign="top" class="imagen_fondo_menu_lateral_inf" height="25">&nbsp;</td>
                </tr>
			</table>
		</td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								<td align="right" width="70%">                                	
									<?php $this->enlace_imprimir("Imprimir contenido","_blank");?>
								</td>
								<td align="right">
									<?php $this->enlace_recomendar($sec, "Recomendar a un amigo"); ?>	
								</td>
							</tr>
						</table>
					</td>
