...
function GetUrlFromPath( $resourceType, $folderPath )
{
	...
	if ( $Config['ConfigDirectories'][$resourceType] == '' )
		...
		return $GLOBALS["UserFilesPath"] . strtolower( $Config['ConfigDirectories'][$resourceType] ) . $folderPath ;
}
...
function ServerMapFolder( $resourceType, $folderPath )
{
	...
	$sResourceTypePath = $GLOBALS["UserFilesDirectory"] . strtolower( $Config['ConfigDirectories'][$resourceType] ) . '/' ;
