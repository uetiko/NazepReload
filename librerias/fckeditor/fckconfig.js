...
FCKConfig.ToolbarSets["texto_simple"] = [
	[ 'NewPage','PasteText','Undo','Redo','SpecialChar','About']
] ;
...
FCKConfig.ToolbarSets["archivos"] = [
	['Link']
] ;
FCKConfig.ToolbarSets["vacio"] = [
	[]
] ;
...
FCKConfig.LinkUploadDeniedExtensions	= ".(html|htm|phtml|pwml|inc|asp|aspx|ascx|jsp|cfm|cfc|pl|bat|exe|com|dll|vbs|js|reg|cgi|htaccess|asis|sh|shtml|shtm|phtm)$" ;	// empty for no one
...
FCKConfig.FlashUploadAllowedExtensions	= ".(swf|fla|xml)$" ;		// empty for all
